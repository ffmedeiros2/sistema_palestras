...
@Stateless
@Path("entidades.sala")
public class SalaFacadeREST extends AbstractFacade<Sala> {

    @PersistenceContext(unitName = "sistema_palestrasPU")
    private EntityManager em;

    public SalaFacadeREST() {
        super(Sala.class);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Sala entity) {
        super.edit(entity);
    }
    ...
    public Sala find(@PathParam("id") Integer id) {
